 ...
 * If we get YUV directly, maybe we can skip at least the conversion to Y?
 * How to get color (H) from YUV? Do we need it to be H? */
__kernel void convert_rgb_to_h_and_y(global uchar* rgbimg,
				     global int2* Data, int width) {
