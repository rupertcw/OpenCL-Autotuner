...
//    cout << modeFlag << endl;
    ...
    SilhouetteExtraction se1(filename, num_training_frames, true, type, tiles, device);
...
//                }
                ...
                SilhouetteExtraction se(filename, num_training_frames, true, type, tiles, device);
