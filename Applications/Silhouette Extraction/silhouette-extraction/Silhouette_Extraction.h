...
class SilhouetteExtraction {
    public:
        ...
        ~SilhouetteExtraction();
        SilhouetteExtraction(string input, int num_training_frames, bool isFile, int type, bool tiles, int device);
    ...
    private:
        ...
        * step, and used throughout the program. */
        ...
        cl::Image2D image2d_fgmask1;
        cl::Image2D image2d_fgmask2;
        cl::Image2D image2d_fgmask3;
        cl::Image2D image2d_fgmask4;
        cl::Image2D image2d_fgmask5;
